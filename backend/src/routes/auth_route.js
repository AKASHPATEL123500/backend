...
import { signupSchema } from '../validators/auth_validator.js';
import { changePasswordSchema } from '../validators/user_validator.js';
...
authRoute.post( "/change-password",verifyToken,validate(changePasswordSchema),changeCurrentPassword )
